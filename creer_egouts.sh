...
mkdir -p egouts/entree egouts/gauche egouts/droite egouts/centre egouts/fin egouts/culdesac
...
echo "Vous avez pris un mauvais chemin et êtes dans un cul-de-sac." > egouts/culdesac/description.txt
